...
use local_deleteoldcourses\cvh_course_enqueuer;
use local_deleteoldcourses\datetime_manager;

defined('MOODLE_INTERNAL') || die();

/**
 * Enqueue courses task for cvh.
 *
 * @package    local_deleteoldcourses
 * @since      Moodle 3.10
 * @author     Iader E. García Gómez <iadergg@gmail.com>
 ...
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class cvh_enqueue_courses_task extends \core\task\scheduled_task {
    ...
    public function execute() {
        ...
        $coursedispatcher = new cvh_course_enqueuer();
        $coursedispatcher->get_courses_to_enqueue(0, $timecreatedcriteria, $timemodificationcriteria, $limitquerytoenqueuecourses);
